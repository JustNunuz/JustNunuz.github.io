              ...
              <>
                ...
                {featured && (
                  <Link
                    ...
                    className="group block mb-10 p-8 md:p-10 rounded-lg border border-border bg-card hover:border-primary/50 transition-all duration-300 opacity-0 animate-fade-in-up relative overflow-hidden"
                  >
